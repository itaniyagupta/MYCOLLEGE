...
//                Snackbar.make(view, "Messaging is coming soon!", Snackbar.LENGTH_LONG)
...
//        });
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    TeacherActiviyFragment activiyFragment = new TeacherActiviyFragment();
                    return activiyFragment;
                case 1:
    ...
    public void onBackPressed() {
        if (!isUserClickedBackButton) {
            Toast.makeText(TeacherDashboardActivity.this, "Press again to to exit.", Toast.LENGTH_SHORT).show();
